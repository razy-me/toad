...
(async () => {
  ...
  const svg = `<svg xmlns="http://www.w3.org/2000/svg" width="600" height="200">
    <defs>
      <filter id="fShadow" x="-50%" y="-50%" width="200%" height="200%">
        <feDropShadow dx="20" dy="20" stdDeviation="0" flood-color="#ff0000" flood-opacity="1" />
      </filter>
    </defs>
  ...
  fs.writeFileSync('C:/toad/vario-nova/dark/test_dropshadow_support.png', c.toBuffer('image/png'));
  console.log('Saved test_dropshadow_support.png');
})();
